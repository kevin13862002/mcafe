...
async function test() {
  ...
  try {
    ...
    console.log('2️⃣  Fetching current products...');
    ...
    console.log('3️⃣  Adding a test product...');
    const testProduct = {
    ...
    if (addRes.status === 200 || addRes.status === 201) {
      ...
      console.log('4️⃣  Verifying product was added...');
      ...
      if (newProductCount > productCount) {
        ...
        console.log('⚠️  WARNING: Product count did not increase\n');
      }
